...
function caricaMateria() {
    $("#benvenuto").text("Benvenuti nella sezione: " + materia.Nome + ".");
    $("#descrizione").text(materia.Descrizione);
    $("#sfondo").attr("src", materia.Foto);
  }
